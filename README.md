...
Листы с маршрутом остаются в тетради до тех пор, пока не будет зарисована часть уже известного участка.
...
matplotlib - отображение лабиринта картинкой(не обязательно, в simple_maze.py можно раскомментировать импорт и функцию)
